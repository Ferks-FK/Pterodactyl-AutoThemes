...
mkdir -p temp
cd temp
curl -sSLo TangoTwist.tar.gz https://raw.githubusercontent.com/Alok-NetWork/Pterodactyl-AutoThemes/${SCRIPT_VERSION}/themes/version0.7.19/TangoTwist/TangoTwist.tar.gz
